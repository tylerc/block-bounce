...
Simply run @block.bat@ (usually a double click)
...
@level.bat@
* See "doc/LEVEL-TUTORIAL.txt":doc/LEVEL-TUTORIAL.txt for a tutorial on making levels
* See "doc/LEVEL-DOC.txt":doc/LEVEL-DOC.txt for full information
* See "doc/LEVEL-PROPERTIES-DOC.txt":doc/LEVEL-PROPERTIES-DOC.txt for information on adding level properties

h2. Running the Level Properties Editor

@properties.bat@

* See "doc/LEVEL-PROPERTIES-DOC.txt":doc/LEVEL-PROPERTIES-DOC.txt for more information
...
See "doc/SPRITE-DOC.txt":doc/SPRITE-DOC.txt for full information
